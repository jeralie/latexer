...
We need to show that $|Q| \le |N|$ to prove that Q is countable. Use the spiral proof detailed in lecture to map each pair (a,b)
to its position along the spiral, where each position is a value in $|N|.
